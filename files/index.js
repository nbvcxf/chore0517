...
const UUID = process.env.UUID || 'bcdecf0b-d535-4b85-ac29-820fe7d1c6cd'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.hani.nyc.mn';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'J98JaH0S4R5pXNHWon';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'chore0517.qewrw436.dpdns.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNjU3ODA0OThlN2Q1MjRhMmQxZjY0MWExODIxOGY0NjgiLCJ0IjoiYmRiYWM4M2UtNTU1NS00MDk2LTk2OTAtZDMwZjY2NTdmMDQyIiwicyI6Ik1tUmhZamt6TUdNdFpHUTRNUzAwTkdKbUxUazNPVE10WXpsa00yWTFOemN6TjJNMiJ9';
const CFIP = process.env.CFIP || 'trodo.com';
const NAME = process.env.NAME || 'Choreo-05177';
